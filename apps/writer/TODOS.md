...
- Fork ownership metadata: [`SPECs/fork-ownership-config-spec.md`](SPECs/fork-ownership-config-spec.md) — add README fork/license notices and point release, website, Cloudflare Worker, and e2e bundle metadata at the fork repository.
