...
- Verifiable Grounded Answers: [`SPECs/Agent/worksheet-verifiable-grounded-answers.md`](SPECs/Agent/worksheet-verifiable-grounded-answers.md), [GitHub #13](https://github.com/Maidang1/madinah/issues/13) — knowledge prompts require relative Document citations; Writer validates live Workspace Markdown/MDX evidence (including heading anchors), navigates valid Sources, and marks answers without valid evidence Ungrounded; no embeddings/index.
