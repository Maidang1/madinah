...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::assistant_turn::list_assistant_conversations,
            commands::assistant_turn::create_assistant_conversation,
            commands::assistant_turn::rename_assistant_conversation,
            commands::assistant_turn::select_assistant_conversation,
            commands::assistant_turn::delete_assistant_conversation,
            commands::assistant_turn::remember_assistant_agent,
