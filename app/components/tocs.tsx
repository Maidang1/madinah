...
export const Tocs = ({ tocs, activeId, progress, onLinkClick }: TocsProps) => {
  ...
  return <>
        ...
        return (
          <NavLink
            ...
            className={cn(
              ...
              'text-muted-foreground hover:text-purple hover:bg-accent/50',
              'border-l-2 border-transparent relative group ml-0',
              isActive && ['text-purple font-medium bg-primary/10 dark:bg-primary/20 dark:text-white'],
            )}
          >
    ...
    <div className='inline-flex items-center justify-between gap-1 text-xs mt-4 ml-2 text-purple'>
      {/* @ts-ignore */}
      <div className="radial-progress text-purple text-xs" style={{ "--value": progress, "--size": "1rem" } as React.CSSProperties} aria-valuenow={progress} role="progressbar" />
