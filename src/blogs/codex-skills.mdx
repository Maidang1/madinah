...
author: Madinah
description: How Codex loads skills, injects skill instructions, and uses skill names during tool routing.
tags:
  - codex
...
[Agent Skills](https://agentskills.io/home) explains the general idea behind skills. This note focuses on the Codex implementation: where skills are loaded, how they enter the prompt context, and how they affect tool routing.
